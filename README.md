...
1. Clone this repository `p1_navigation_as/`
...
4. Optionally if an appropriate GPU is present and you wish to use it, install Cuda as required by the OS in use, see [cuda](https://docs.nvidia.com/cuda/)

### Instructions

Follow the instructions in `P1_navigation_DDQN_01.ipynb` to get started and see how this agent was trained!  

### (Optional) Challenge: Improve the agent

After you have successfully ran the code for this project, if you're looking for an additional challenge, you could try and improve the score by modifying or writting your own code!  In the project, the agent learned from information such as its velocity, along with ray-based perception of objects around its forward direction. 
